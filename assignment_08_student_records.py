...
def compute_average(scores):
    """Calculates the average of a list of scores rounded to 2 decimal places."""
    if not scores:
        return 0.0
...
def add_student(students):
    """Collects student details from the user and appends a record dictionary."""
    ...
    try:
        ...
        for i in range(1, num_scores + 1):
            ...
            scores.append(score)
        # Dictionary structure requirement
        new_student = {
            "name": name,
            "id": student_id,
            "scores": scores
        ...
        print("Error: Invalid numerical input. Operation cancelled.")
# -----------------------------------------------------------------------------
# FEATURE 2: Display All Students
# -----------------------------------------------------------------------------
def display_all_students(students):
    """Prints a formatted table showing every student's details."""
    if not students:
...
def display_menu():
    ...
    print("4. Quit")
def main():
    students = []  # Master list storing student record dictionaries
